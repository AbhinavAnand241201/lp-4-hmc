...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-bg-primary relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-accent-primary/5 rounded-full blur-3xl floating-animation"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-accent-secondary/5 rounded-full blur-3xl floating-animation" style={{ animationDelay: '4s' }}></div>
      ...
      <header className="relative z-10 px-6 py-8">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-text-primary text-lg font-semibold">GPTCH Wallet</span>
          </div>
      ...
      <main className="relative z-10 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-20">
            <div className="mb-12">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 font-display">
                <span className="text-gradient">GPTCH Wallet</span>
              </h1>
          ...
          <div id="features" className="grid md:grid-cols-3 gap-8 mb-20">
            ...
            <div className="feature-card-minimal text-center">
              <div className="w-16 h-16 bg-gradient-tertiary rounded-2xl flex items-center justify-center mx-auto mb-6">
          ...
          <div className="glass-card rounded-3xl p-12 mb-20">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-8 font-display">
                  모던한 사용자 경험
                </h2>
                  ...
                  <div className="w-64 h-80 bg-gradient-primary rounded-3xl p-1 minimal-glow">
                    <div className="w-full h-full bg-bg-card rounded-2xl flex items-center justify-center p-6">
                      <div className="text-center">
                        ...
                        <p className="text-text-primary font-semibold text-lg mb-2">GPTCH Wallet</p>
          ...
          <div id="download" className="text-center glass-card rounded-3xl p-12">
            ...
            <p className="text-text-secondary text-lg mb-8 max-w-xl mx-auto">
              GPTCH Wallet 모바일 앱을 다운로드하고 암호화폐 거래를 시작하세요
            </p>
            <button
              onClick={handleDownload}
              className="minimal-button flex items-center space-x-3 mx-auto"
