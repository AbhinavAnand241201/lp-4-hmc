...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-yellow-main/20 rounded-full blur-3xl floating-animation"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-yellow-main/20 rounded-full blur-3xl floating-animation" style={{ animationDelay: '4s' }}></div>
      
      {/* Header */}
      <header className="relative z-10 px-6 py-8">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-xl overflow-hidden bg-yellow-main flex items-center justify-center">
              <Image 
                src="/stoy.png" 
                alt="STOY Wallet Logo" 
                width={40} 
                height={40}
                className="w-full h-full object-cover"
              />
            </div>
            <span className="text-gradient text-lg font-semibold">STOY</span>
          </div>
      ...
      <main className="relative z-10 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-20">
            <div className="mb-12">
              <div className="w-24 h-24 rounded-2xl overflow-hidden mx-auto mb-8 minimal-glow bg-yellow-main flex items-center justify-center">
                <Image 
                  src="/stoy.png" 
                  alt="STOY Wallet Logo" 
                  width={96} 
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 font-display">
                <span className="text-gradient">STOY</span>
              </h1>
          ...
          <div id="features" className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="feature-card-minimal text-center">
              <div className="w-16 h-16 bg-yellow-main rounded-2xl flex items-center justify-center mx-auto mb-6">
          ...
          <div className="glass-card rounded-3xl p-12 mb-20">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl text-2xl font-bold text-black mb-4 font-display">
                  모던한 사용자 경험
                </h2>
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    <div className="w-2 h-2 bg-yellow-main rounded-full"></div>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="w-2 h-2 bg-white-main rounded-full"></div>
              ...
              <div className="flex justify-center">
                <div className="relative">
                  <div className="w-64 h-80 bg-yellow-main rounded-3xl p-1 minimal-glow">
                    <div className="w-full h-full bg-white-main/60 rounded-2xl flex items-center justify-center p-6">
                      <div className="text-center">
                        ...
                        <p className="text-gradient font-semibold text-lg mb-2">STOY Wallet</p>
          ...
          <div id="download" className="text-center glass-card rounded-3xl p-12">
            ...
            <p className="text-black text-lg mb-8 max-w-xl mx-auto">
              STOY Wallet 모바일 앱을 다운로드하고 암호화폐 거래를 시작하세요
            </p>
            <button
              onClick={handleDownload}
              className="minimal-button flex items-center space-x-3 mx-auto"
      ...
      {/* Minimal Footer */}
      <footer className="relative z-10 py-8 border-t border-yellow-main/30 bg-yellow-light">
