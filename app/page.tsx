...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-pink-main/20 rounded-full blur-3xl floating-animation"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-main/20 rounded-full blur-3xl floating-animation" style={{ animationDelay: '4s' }}></div>
      ...
      <header className="relative z-10 px-6 py-8">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-gradient text-lg font-semibold">GNG Wallet</span>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-20">
            <div className="mb-12">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 font-display">
                <span className="text-gradient">GNG Wallet</span>
              </h1>
          ...
          <div id="features" className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="feature-card-minimal text-center">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">보안</h3>
            ...
            <div className="feature-card-minimal text-center">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">빠른 거래</h3>
              <p className="text-text-secondary text-sm leading-relaxed">
            ...
            <div className="feature-card-minimal text-center">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">모바일 최적화</h3>
              <p className="text-text-secondary text-sm leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    <div className="w-2 h-2 bg-pink-main rounded-full"></div>
                    <span className="text-text-secondary font-medium">직관적인 인터페이스</span>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="w-2 h-2 bg-blue-main rounded-full"></div>
              ...
              <div className="flex justify-center">
                <div className="relative">
                  <div className="w-64 h-80 bg-gradient-primary rounded-3xl p-1 minimal-glow">
          ...
          <div id="download" className="text-center glass-card rounded-3xl p-12">
            ...
            <p className="text-black text-lg mb-8 max-w-xl mx-auto">
              GNG Wallet 모바일 앱을 다운로드하고 암호화폐 거래를 시작하세요
            </p>
            <button
              onClick={handleDownload}
              className="minimal-button flex items-center space-x-3 mx-auto"
